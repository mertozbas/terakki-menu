...
const FOOD_MENU_TR: Section[] = [
  {
    category: 'Başlangıç',
    items: [
      { name: 'Itırlı Tereyağ & Ekşi Mayalı Ekmek' },
      { name: 'İsli Yoğurt ve Kızarmış Patron Biberi', price: '540 ₺' },
      { name: 'Rakılı Çıtır Ördek', description: 'Ekşi sote radika ile', price: '700 ₺' },
      { name: 'Izgara Ahtapot', description: 'Chimichurri soslu', price: '1.525 ₺' },
      { name: 'Portakallı Enginar', description: 'Arpacık soğan ile', price: '940 ₺' },
      { name: 'Pancar Carpaccio', description: 'Ricotta peyniri ile', price: '785 ₺' },
      { name: 'İsli Tahinli Izgara Patlıcan', price: '785 ₺' },
      { name: 'Şiş Karides', description: 'Izgara lime & chili mayonez', price: '1.070 ₺' },
      { name: 'Izgara Şiş Baby Kalamar', price: '1.070 ₺' },
      { name: 'Mangolu Levrek Marin', price: '960 ₺' },
      { name: 'Meze Trio I', description: 'Hardallı humus, girit ezme, ceviz reçelli muhammara', price: '890 ₺' },
      { name: 'Meze Trio II', description: 'Köpük haydari, pembe sultan, atom', price: '890 ₺' },
      { name: 'Izgara Ciğer', price: '1.100 ₺' },
      { name: 'Atom Kokoreç', description: 'Avokado ile', price: '1.525 ₺' },
      { name: 'Yeşil Zeytinli Soğan Dolması', price: '940 ₺' },
      { name: 'Mersin Patates', description: 'Füme antrikot, kıl biber ile', price: '1.425 ₺' },
      { name: 'Çıtır Kabak Çiçeği', price: '710 ₺' },
      { name: 'Izgara İstiridye Mantarı', price: '810 ₺' },
      { name: 'Rakı Tabağı', description: 'Ovacık kavun, ezine peyniri, çıtır ceviz', price: '680 ₺' },
    ],
  },
  {
    category: 'Salata',
    items: [
      { name: 'İstanbul Salata', price: '800 ₺' },
      { name: 'Kuru Bacon & Yedikule Salatası', price: '950 ₺' },
      { name: 'Terakki Yeşil Salata', price: '900 ₺' },
      { name: 'Kaşık Salata', price: '900 ₺' },
    ],
  },
  {
    category: 'Ana Yemek',
    items: [
      { name: 'Izgara Levrek', price: '1.400 ₺' },
      { name: 'Kuzu Sırtı', description: 'Sıcak humus ve ege otları ile', price: '2.250 ₺' },
      { name: 'Vişne Reçelli Minekop', price: '1.400 ₺' },
      { name: 'İstiridye Mantarlı Bonfile', price: '2.250 ₺' },
    ],
  },
  {
    category: 'Tatlı',
    items: [
      { name: 'Çıtır Baklava', price: '780 ₺' },
      { name: 'Tiramisu', price: '780 ₺' },
    ],
  },
];
...
const FOOD_MENU_EN: Section[] = [
  {
    category: 'Starters',
    items: [
      { name: 'Herb Butter & Sourdough Bread' },
      { name: 'Smoked Yogurt with Fried Padrón Pepper', price: '540 ₺' },
      { name: 'Crispy Duck with Rakı', description: 'With sautéed radicchio', price: '700 ₺' },
      { name: 'Grilled Octopus', description: 'Chimichurri sauce', price: '1.525 ₺' },
      { name: 'Orange Artichoke', description: 'With pearl onion', price: '940 ₺' },
      { name: 'Beet Carpaccio', description: 'With ricotta cheese', price: '785 ₺' },
      { name: 'Smoked Tahini Grilled Eggplant', price: '785 ₺' },
      { name: 'Shrimp Skewer', description: 'Grilled with lime & chili mayo', price: '1.070 ₺' },
      { name: 'Grilled Baby Calamari Skewer', price: '1.070 ₺' },
      { name: 'Mango Marinated Sea Bass', price: '960 ₺' },
      { name: 'Mezze Trio I', description: 'Mustard hummus, Cretan spread, muhammara with walnut jam', price: '890 ₺' },
      { name: 'Mezze Trio II', description: 'Foamy haydari, pink sultan, atom', price: '890 ₺' },
      { name: 'Grilled Liver', price: '1.100 ₺' },
      { name: 'Atom Kokoreç', description: 'With avocado', price: '1.525 ₺' },
      { name: 'Green Olive Stuffed Onion', price: '940 ₺' },
      { name: 'Mersin Potato', description: 'Smoked entrecôte, hair pepper', price: '1.425 ₺' },
      { name: 'Crispy Zucchini Flower', price: '710 ₺' },
      { name: 'Grilled Oyster Mushroom', price: '810 ₺' },
      { name: 'Rakı Plate', description: 'Ovacık melon, Ezine cheese, crispy walnut', price: '680 ₺' },
    ],
  },
  {
    category: 'Salad',
    items: [
      { name: 'Istanbul Salad', price: '800 ₺' },
      { name: 'Cured Bacon & Yedikule Salad', price: '950 ₺' },
      { name: 'Terakki Green Salad', price: '900 ₺' },
      { name: 'Spoon Salad', price: '900 ₺' },
    ],
  },
  {
    category: 'Mains',
    items: [
      { name: 'Grilled Sea Bass', price: '1.400 ₺' },
      { name: 'Lamb Loin', description: 'With warm hummus and Aegean herbs', price: '2.250 ₺' },
      { name: 'Meagre with Cherry Preserve', price: '1.400 ₺' },
      { name: 'Tenderloin with Oyster Mushrooms', price: '2.250 ₺' },
    ],
  },
  {
    category: 'Dessert',
    items: [
      { name: 'Crispy Baklava', price: '780 ₺' },
      { name: 'Tiramisu', price: '780 ₺' },
    ],
  },
];
